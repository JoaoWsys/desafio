...
namespace Questao1 {
    class Program {
        static void Main(string[] args) {
            ...
            Console.WriteLine();
            Console.Write("Gostaria de alterar o nome do Titular da conta (s/n)? ");
            resp = char.Parse(Console.ReadLine());
            if (VerificaResposta(resp))
            {
                Console.Write("Digite o nome de titular que deseja atribuir a sua conta: ");
                string titularAlterado = Console.ReadLine();
                conta.AlteracaoNomeTitular(titularAlterado);
            }
        ...
        private static bool VerificaResposta(char resposta)
        {
